...
data class CategoryPropertyListItem(val data: CategoryProperty, val selectionIndex: Int) : ListItem()
...
data class CategoryPropertyClick(val categoryProperty: CategoryProperty, val index: Int) : ItemClickAction()